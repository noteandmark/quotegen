...
- погадать на книге: назвав страницу и строку, бот случайно выбирает книгу и находит заданное место
- получить случайную цитату из опубликованных
- получить все цитаты за неделю

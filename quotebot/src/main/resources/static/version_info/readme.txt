...
- получить статистику
- получить анимированный случайный ответ "да" или "нет"
- погадать на книге: назвать страницу и строку, и бот, случайно выбрав книгу, найдет указанное место
...
- отправить сообщение админу бота: баг, отзыв, предложение, улучшение

Админ может:
- сканировать директорию на наличие электронных книг и сохранять их в БД
- делать запрос о генерации случайной цитаты
- получать по расписанию один раз в день случайную цитату

Бот также по расписанию проверяет отложенные к публикации цитаты по заданному интервалу времени.
